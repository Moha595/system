...
const youtube = new YouTube("AIzaSyBN1JJw5zIjSVu7HsU7jhNoZyZWhClmDSw"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyBN1JJw5zIjSVu7HsU7jhNoZyZWhClmDSw"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@690902202968965141>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
              ...
              m.channel
                ...
                .then(m2 => {
                  ...
                  message.channel
                    ...
                    .then(m => {
                      m.edit(message.member + ", **هل كنت اداري سابق او مبرمجا لسيرفر ما🎙**");
                      setTimeout(() => {
                        m.delete();
                      }, 10000);
                      m.channel
                                    ...
                                    .then(m => {
                                      ...
                                      m.channel
                                        ...
                                        .then(m5 => {
                                          ...
                                          m.edit(
                                            message.member +
                                              ", **جاري جمع البيانات...و سيتم الرد عليك قريبا انشاءالله**"
                                          ).then(mtime => {
                                            setTimeout(() => {
                                              let embed = new Discord.RichEmbed()
                                                .setColor("RANDOM")
                                                ...
                                                .addField(
                                                  "**`هل كنت اداري سابق او مبرمجا لسيرفر ما`**",
                                                  `${ask}`
                                                )
                                                .addField(
